  ...
  try {
    ...
    const formattedUsers = users.map(user => ({
      ...
      updatedAt: user.updated_at
        ...
        : '',
      avatar: formatImageUrl(user.avatar_url, req) || `https://ui-avatars.com/api/?name=${encodeURIComponent(user.full_name)}&background=random`
    }));
...
exports.updateUser = async (req, res) => {
  try {
    ...
    const formattedUser = {
      ...
      status: u.status,
      avatar: formatImageUrl(u.avatar_url, req) || `https://ui-avatars.com/api/?name=${encodeURIComponent(u.full_name)}&background=random`
    };
