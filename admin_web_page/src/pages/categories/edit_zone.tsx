...
const EditZone: React.FC<EditZoneProps> = ({ isOpen, onClose, onSuccess, zone }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await apiService.put(`/zones/${zone.id}`, formData);
            if (response.success) {
                onSuccess();
                onClose();
            } else {
            ...
            <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-md">
                ...
                <div className="flex items-center justify-between px-6 py-5 border-b border-slate-100">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-slate-900">Chỉnh sửa khu vực</h2>
                            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Cập nhật thông tin khu vực #{zone.id}</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="px-8 py-8">
                    ...
                    <form id="edit-zone-form" onSubmit={handleSubmit} className="space-y-6">
